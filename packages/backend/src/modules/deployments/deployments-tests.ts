...
describe("change-log", async () => {
  ...
  describe("GET /api/v1/websites/{id}/deployments", () => {
    it("should return 200 when a deployment array of objects is returned", async () => {
      const res = await app.inject({
        method: "GET",
        url: `/api/v1/websites/${id}/deployments`,
        headers: {
